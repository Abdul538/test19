        ...
        child: ClipRect(
          child: SizedBox(
            ...
            child: PageView.builder(
              ...
              // Pra-bangun & simpan halaman tetangga (bukan cuma yang lagi
              // tampil) — jadi animasi masuk baris hari (fadeIn/slideX di
              // `_DayListSection`) sudah kelar SEBELUM jari mulai narik ke
              // sana, bukannya baru mulai animasi PAS lagi di-drag (itu
              // yang bikin kerasa patah-patah, karena animasi masuk & drag
              // rebutan jatah frame bersamaan). Tidak mengubah urutan atau
              // hasil akhir apa pun, cuma waktu build-nya dimajukan.
